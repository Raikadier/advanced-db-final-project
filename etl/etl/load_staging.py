"""
load_staging.py — Carga de datos transformados a la Staging Area (Supabase)
"""
...
from etl.config import TABLE_MAP
...
def load_all(
    ...
    """Carga todas las tablas en el orden definido."""
    summary = {}
    errors = []
    ...
    logger.info(
        f"Carga staging completada: {len(summary) - len(errors)} tablas OK | "
